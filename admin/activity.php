<?php
/**
 * Palami Shoppers Kagoma - User Activity Log
 */
...
<head>
    ...
    <title>Palami Shoppers Kagoma - User Activity</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-create { background: #cce5ff; color: #004085; }
...
<body>
        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="activity.php" class="dropdown-item active"><i class="fas fa-history"></i> User Activity</a></li>
                </ul>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                <h2><i class="fas fa-history"></i> User Activity</h2>
                <div class="breadcrumb">
                    <a href="dashboard.php">Dashboard</a> / <a href="users.php">Users</a> / User Activity
                </div>
            </div>
        ...
        <form method="GET" class="filter-bar">
            ...
            <a href="activity.php" class="btn btn-outline"><i class="fas fa-undo"></i> Reset</a>
        </form>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="number green"><?php echo $stats['login']; ?></div>
                <div class="label"><i class="fas fa-sign-in-alt"></i> Logins</div>
            </div>
            <div class="stat-card">
                <div class="number blue"><?php echo $stats['create']; ?></div>
                <div class="label"><i class="fas fa-plus-circle"></i> Created</div>
            </div>
            <div class="stat-card">
                <div class="number orange"><?php echo $stats['update']; ?></div>
                <div class="label"><i class="fas fa-edit"></i> Updated</div>
            </div>
            <div class="stat-card">
                <div class="number red"><?php echo $stats['delete']; ?></div>
                <div class="label"><i class="fas fa-trash"></i> Deleted</div>
            </div>
            <div class="stat-card">
                <div class="number" style="color:#95a5a6;"><?php echo $stats['logout']; ?></div>
                <div class="label"><i class="fas fa-sign-out-alt"></i> Logouts</div>
            </div>
        </div>
        ...
        <div style="margin-top:20px;text-align:center;color:#95a5a6;font-size:12px;">
            <p>Showing <?php echo count($logs); ?> activity logs</p>
        </div>
