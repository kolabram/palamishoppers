<?php
/**
 * Palami Shoppers Kagoma - Inventory Report
...
try {
    ...
    $summary = [
        ...
        'total_value' => array_sum(array_map(function($p) { return $p['current_stock'] * $p['unit_price']; }, $products)),
        'low_stock_count' => count(array_filter($products, function($p) { return $p['stock_status'] == 'low_stock'; })),
        'out_of_stock_count' => count(array_filter($products, function($p) { return $p['stock_status'] == 'out_of_stock'; })),
        'avg_stock' => count($products) > 0 ? array_sum(array_column($products, 'current_stock')) / count($products) : 0,
    ];
...
<head>
    ...
    <title>Palami Shoppers Kagoma - Inventory Report</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        /* Same styles as sales_report.php */
...
<body>
        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="inventory_report.php" class="dropdown-item active"><i class="fas fa-warehouse"></i> Inventory Report</a></li>
                    <li><a href="reports.php?type=products" class="dropdown-item"><i class="fas fa-box"></i> Product Report</a></li>
                    <li><a href="reports.php?type=users" class="dropdown-item"><i class="fas fa-users"></i> User Activity</a></li>
                </ul>
            </li>
    ...
    <div class="container">
        <div class="page-header">
            <div>
                <h2><i class="fas fa-warehouse"></i> Inventory Report</h2>
                <div class="breadcrumb"><a href="dashboard.php">Dashboard</a> / <a href="reports.php">Reports</a> / Inventory Report</div>
            </div>
        ...
        <form method="GET" class="filter-bar">
            ...
            <a href="inventory_report.php" class="btn btn-outline"><i class="fas fa-undo"></i> Reset</a>
        </form>

        <div class="summary-row">
            <div class="summary-item">
                <div class="value" style="color:#ffd700;">UGX <?php echo number_format($summary['total_value'], 2); ?></div>
                <div class="label">Total Inventory Value</div>
            </div>
            <div class="summary-item">
                <div class="value"><?php echo $summary['total_products']; ?></div>
                <div class="label">Total Products</div>
            </div>
            <div class="summary-item">
                <div class="value"><?php echo $summary['total_stock']; ?></div>
                <div class="label">Total Stock Units</div>
            </div>
            <div class="summary-item">
                <div class="value" style="color:<?php echo $summary['low_stock_count'] > 0 ? '#f39c12' : '#27ae60'; ?>;">
                    <?php echo $summary['low_stock_count']; ?>
                </div>
                <div class="label">Low Stock Items</div>
            </div>
            <div class="summary-item">
                <div class="value" style="color:<?php echo $summary['out_of_stock_count'] > 0 ? '#e74c3c' : '#27ae60'; ?>;">
                    <?php echo $summary['out_of_stock_count']; ?>
                </div>
                <div class="label">Out of Stock</div>
            </div>
            <div class="summary-item">
                <div class="value"><?php echo number_format($summary['avg_stock'], 1); ?></div>
                <div class="label">Avg Stock/Product</div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo $product['stock_status'] == 'in_stock' ? 'badge-success' : ($product['stock_status'] == 'low_stock' ? 'badge-warning' : 'badge-danger'); ?>">
                                        <?php echo $product['stock_status'] == 'in_stock' ? '✅ In Stock' : ($product['stock_status'] == 'low_stock' ? '⚠️ Low Stock' : '🚫 Out of Stock'); ?>
                                    </span>
                                </td>
                                <td><?php echo $product['sales_count'] ?? 0; ?></td>
                                <td><strong>UGX <?php echo number_format($product['current_stock'] * $product['unit_price'], 2); ?></strong></td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
